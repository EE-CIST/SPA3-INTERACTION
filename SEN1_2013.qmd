...
map<-readRDS("GEO/SEN/SEN1_map_OK.RDS")
...
mf_label(map,var="code",col="white",cex = 0.5,overlap = F)
...
don <- don %>% filter(Pays == "Senegal", YEAR==2013)
  

miglong<-don %>% mutate(i = COD_NAISSANCE_Niv1,
